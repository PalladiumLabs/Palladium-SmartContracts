...
contract FunctionCaller {
	...
	function troveManager_getCurrentICR(
		...
		return ITroveManager(troveManager).getCurrentICR(_asset, _address, _price);
	}
	...
	function sortedTroves_findInsertPosition(
		...
		return ISortedTroves(sortedTroves).findInsertPosition(_asset, _NICR, _prevId, _nextId);
	}
}
