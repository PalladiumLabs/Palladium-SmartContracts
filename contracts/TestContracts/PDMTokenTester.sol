...
import "../PDM/PDMToken.sol";

contract PDMTokenTester is PDMToken {
	constructor(address _treasury) PDMToken(_treasury) {}
	...
	function unprotectedTransferFrom(address _sender, address _receiver, uint256 _amount) external {
